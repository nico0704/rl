...
#       - A minimap at the top right corner showing a 2D top view of the track with a red dot as car indicator
#       - A speed bar visualizing the car speed
#       - A info box at the top left corner showing the current state [car speed, car angle, sensor data]
